...
\title{Implementation/Code}
\begin{document}
\maketitle
<<>>=
## Importing the data
customer_data=read.csv("C:/Users/mogal/OneDrive/Documents/edaproject/Project/Project/Code/Mall_Customers.csv")
customer_data
str(customer_data)
...
## we will create visualizations to analyze the spending score of the customers. We will plot a boxplot and then we will proceed to examine this data using a histogram for spending score.
